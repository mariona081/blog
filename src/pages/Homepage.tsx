            ...
            <section className="flex flex-col  items-center justify-center text-center h-screen">
                <div className=" relative group flex flex-col items-center justify-center">
                    <div className="relative w-80 ">
                        <img className="w-80 h-auto group-hover:opacity-0 transition-opacity duration-200 cursor-pointer" src="/img/marion.png" loading="eager"/>
                        <img className="w-90 h-auto absolute top-0 left-0 opacity-0 group-hover:opacity-100 transition-opacity duration-200 cursor-pointer" src="/img/marionHover.png" loading="eager"/>
                    </div>
